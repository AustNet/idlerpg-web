...
echo('<html><head><title>'. $irpg_chan .' Idle RPG: Game Info</title>');
...
echo('
    ...
    <blockquote>
      <p>
        This IRPG can be played on the '. $irpg_network .' under the channel
	    '. $irpg_chan .'. Please come and join us.
      </p>
      <p> 
        The original Idle RPG can be played on the
    ...
    <blockquote>
      ...
      <blockquote>
        <code>
          /msg '. $irpg_bot .' REGISTER &lt;char name&gt; &lt;password&gt;
          &lt;char class&gt;
        </code>
      </blockquote>
    ...
    <blockquote>
      ...
      <blockquote>
        <code>
          /msg '. $irpg_bot .' LOGIN &lt;char name&gt; &lt;password&gt;
        </code>
      </blockquote>
    ...
    <span class="head1">Changing your Password</span>
    <blockquote>
      <p>To change your password, simply:</p>
      <blockquote>
        <code>
          /msg '. $irpg_bot .' NEWPASS &lt;new password&gt;
        </code>
      </blockquote>
      <p>This is a p0 (see <a href="#penalties">Penalties</a>) command.</p>
    ...
    <span class="head1">Removing your Account</span>
    <blockquote>
      <p>To remove your account, simply:</p>
      <blockquote>
        <code>
          /msg '. $irpg_bot .' REMOVEME
        </code>
      </blockquote>
      <p>This is a p0 (see <a href="#penalties">Penalties</a>) command :^)</p>
    </blockquote>

    <span class="head1">Changing your Alignment</span>
    <blockquote>
      <p>To change your alignment, simply:</p>
      <blockquote>
        <code>
          /msg '. $irpg_bot .' ALIGN &lt;good|neutral|evil&gt;
        </code>
      </blockquote>
      <p>This is a p0 (see <a href="#penalties">Penalties</a>) command.</p>
    ...
    <span class="head1"><a name="info">Obtaining Bot Info</a></span>
    <blockquote>
    ...
    <span class="head1">Levelling</span>
    <blockquote>
    ...
    <blockquote>
      ...
      <blockquote>
        ...
        <b>Name</b>: Juliet\'s Glorious Ring of Sparkliness<br>
        <b>Item Level</b>: 50-74<br>
        <b>User Level</b>: 25 or greater<br>
        <b>Chance to Roll</b>: 1 / 40<br><br>
        ...
        <b>Name</b>: Mrquick\'s Magical Boots of Swiftness<br>
        <b>Item Level</b>: 250-300<br>
        <b>User Level</b>: 48 or greater<br>
        <b>Chance to Roll</b>: 1 / 40<br><br>
        
        <b>Name</b>: Jeff\'s Cluehammer of Doom<br>
        <b>Item Level</b>: 300-350<br>
        <b>User Level</b>: 52 or greater<br>
        <b>Chance to Roll</b>: 1 / 40<br><br>
      </blockquote>
    </blockquote>
    ...
    <a name="grid"><span class="head1">Grid System</span></a>
    <blockquote>
    ...
    <a name="stealing"><span class="head1">Item Stealing</span></a>
    <blockquote>
